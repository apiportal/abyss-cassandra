            ...
            if (preparedStatementMap.containsKey(Cqls.CQL_INSERT_TRAFFIC_LOG)) {
                ...
                if (preparedStatement != null) {
                    cassandraClient.execute(preparedStatement.bind(
                            ...
                            , messageApiTrafficLog.getJsonArray(ApiTraffic.COOKIES)
                            ...
                            , messageApiTrafficLog.getJsonObject(ApiTraffic.REQUEST_HEADERS)
                            , messageApiTrafficLog.getString(ApiTraffic.REQUEST_HOST)
                            , messageApiTrafficLog.getBoolean(ApiTraffic.REQUEST_IS_SSL)
                            , messageApiTrafficLog.getJsonObject(ApiTraffic.REQUEST_PARAMS)
                            ...
                            , messageApiTrafficLog.getJsonObject(ApiTraffic.RESPONSE_HEADERS)
